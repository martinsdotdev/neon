...
const MOCK_ORDERS: Array<Order> = import.meta.env.DEV
  ? [
      {
        carrierId: "c001",
        id: "o001",
      ...
      },
      {
        carrierId: null,
        id: "o003",
        lines: [{ packagingLevel: "Pallet", quantity: 1, skuId: "s005" }],
        priority: "Low",
      },
      {
        carrierId: "c003",
      ...
      },
      {
        carrierId: "c001",
        id: "o005",
        lines: [{ packagingLevel: "Each", quantity: 12, skuId: "s002" }],
        priority: "Normal",
      },
      {
        carrierId: "c002",
        id: "o006",
        lines: [{ packagingLevel: "Case", quantity: 4, skuId: "s003" }],
        priority: "Normal",
      },
      {
        carrierId: null,
        id: "o007",
        lines: [{ packagingLevel: "Each", quantity: 8, skuId: "s001" }],
        priority: "Low",
      },
      {
        carrierId: "c003",
        id: "o008",
        lines: [
          { packagingLevel: "Each", quantity: 6, skuId: "s004" },
          { packagingLevel: "Case", quantity: 3, skuId: "s002" },
        ],
        priority: "High",
      },
      {
        carrierId: "c001",
        id: "o009",
        lines: [{ packagingLevel: "Each", quantity: 15, skuId: "s005" }],
        priority: "Normal",
      },
      {
        carrierId: null,
        id: "o010",
        lines: [{ packagingLevel: "Pallet", quantity: 2, skuId: "s001" }],
        priority: "Low",
      },
    ]
  : []
