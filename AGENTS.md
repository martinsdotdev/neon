...
Guidance for AI coding agents working in this repository — the canonical agent context, shared across tools per the [agents.md](https://agents.md/) convention. Claude Code reads it through `CLAUDE.md`, which imports this file.
