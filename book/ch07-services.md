...
> **Note:** The Policy-Service-Repository pattern is documented in
> [ADR-0002](../docs/decisions/0002-use-policy-service-repository-pattern.md).
...
> **Note:** We will explore error handling patterns in depth in Chapter 18.
> The `Either`-based approach and its rationale are documented in
> [ADR-0004](../docs/decisions/0004-use-either-based-error-handling.md).
