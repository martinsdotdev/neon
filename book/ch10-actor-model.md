...
> **Note:** If you have worked with Akka before, Pekko will feel familiar.
...
> **Note:** We used `withEnforcedReplies` rather than the plain
...
> **Note:** Forgetting `@JsonTypeInfo` on a polymorphic snapshot type is a
...
> **Note:** This structural consistency is deliberate. Learn the pattern once
