...
> **Note:** All four buckets must be non-negative at all times. This means you
...
> **Note:** The allocation policy supports partial fulfillment. If a request
...
> **Note:** In all three cases, the ShortpickPolicy runs separately to
...
> **Note:** The `SegregationOfDutiesViolation` error is a sealed trait case
