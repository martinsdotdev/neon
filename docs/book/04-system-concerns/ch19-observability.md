...
The wide events philosophy is documented in
ADR-0010.
...
`MdcExecutionContext` adds a small overhead per task: one MDC
...
There is a gap between Layer 2 and Layer 3. The HTTP trace ID
